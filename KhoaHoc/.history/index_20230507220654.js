...
//server được khởi động bằng cách gọi phương thức listen() của đối tượng app. Khi server được khởi động thành công, đoạn mã sẽ in ra thông báo "my server port 8888: http://localhost:8888/" trên console.
app.listen(port, () => {
